...
const Restaurants = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <img src="https://picsum.photos/seed/sustainablefood/1200/400" alt="Sustainable Restaurant" className="w-full h-64 object-cover rounded-lg shadow-md" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div key={item} className="bg-white rounded-lg shadow-md overflow-hidden">
            <img src={`https://picsum.photos/seed/food${item}/400/300`} alt="Restaurant" className="w-full h-48 object-cover" />
            <div className="p-4">
